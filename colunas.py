#Esse código lê os dados do CSV e plot os dados de cada coluna sem ordenar
...
ax[0][0].plot(range(c8.size), c1)
ax[0][1].plot(range(c8.size), c2)
ax[0][2].plot(range(c8.size), c3)
ax[0][3].plot(range(c8.size), c4)
ax[1][0].plot(range(c8.size), c5)
ax[1][1].plot(range(c8.size), c6)
ax[1][2].plot(range(c8.size), c7)
ax[1][3].plot(range(c8.size), c8)
